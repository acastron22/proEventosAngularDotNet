    ...
    public class RedeSocialService : IRedeSocialService
    {
        ...
        public async Task<bool> DeleteByEvento(int eventoId, int redeSocialId)
        {
            try
            {
                ...
                if (RedeSocial == null) throw new Exception("Rede Social para deletar não foi encontrado");
        ...
        public async Task<RedeSocialDto[]> GetAllByPalestranteIdAsync(int palestrante)
        {
            try
            {
                var RedeSocials = await _redeSocialPersist.GetAllByPalestranteIdAsync(palestrante);
                if (RedeSocials == null) return null;
                var resultado = _mapper.Map<RedeSocialDto[]>(RedeSocials);
